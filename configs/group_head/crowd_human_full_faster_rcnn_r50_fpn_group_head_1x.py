...
test_cfg = dict(
    rpn=dict(
        ...
        min_bbox_size=0),
    rcnn=dict(
        score_thr=0.8, nms=dict(type='nms', iou_thr=0.01), max_per_img=1000),
    n_iterations=2
)
# dataset settings
...
log_level = 'INFO'
work_dir = './work_dirs/iterdet/crowd_human_full_faster_rcnn_r50_fpn_group_head_2x'
load_from = None
resume_from = None
workflow = [('train', 1)]
