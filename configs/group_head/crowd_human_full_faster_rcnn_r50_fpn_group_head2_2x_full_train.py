...
test_cfg = dict(
    rpn=dict(
        ...
        min_bbox_size=0),
    rcnn=dict(
        score_thr=0, nms=dict(type='nms', iou_thr=0.9), max_per_img=200),
    n_iterations=2
)
# dataset settings
...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(800, 800), keep_ratio=True, final_crop=False),
...
log_level = 'INFO'
work_dir = './work_dirs/iterdet/crowd_human_full_faster_rcnn_r50_fpn_group_head2_2x_full_train'
load_from = None
resume_from = None
workflow = [('train', 1)]
